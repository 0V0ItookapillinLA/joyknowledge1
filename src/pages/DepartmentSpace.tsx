          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="border border-border rounded-xl bg-card p-8 mb-8">
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h1 className="text-3xl font-bold text-foreground mb-6">欢迎来到</h1>
                <div className="px-12 py-5 rounded-xl bg-primary/5 border border-primary/10 mb-6">
                  <span className="text-3xl font-bold text-primary">EI{deptName}</span>
                </div>
                <h2 className="text-3xl font-bold text-foreground mb-8">团队空间</h2>
